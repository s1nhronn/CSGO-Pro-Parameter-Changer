...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        if language == 'en':
            ...
            choose_config = QAction('&��������� ������������ � ����������', self)
            choose_config.setIcon(download_icon)
            choose_config.triggered.connect(self.choose_config)

            create_config = QAction('&������� ������������', self)
            create_config.setIcon(new_config_icon)
            create_config.triggered.connect(self.prepare_to_share)

            choose_table = QAction('&������� ����������� ������������', self)
            choose_table.setIcon(config_icon)
            choose_table.triggered.connect(self.load_table)

            rename_config = QAction('&������������� �������� ������������', self)
            rename_config.setIcon(rename_icon)
            rename_config.triggered.connect(self.rename_active_config)

            change_language = QAction('������� ���� �� ����������', self)
    ...
    def choose_config(self) -> None:
        ...
        global config_now
        if language == 'ru':
            filepath, _ = QFileDialog.getOpenFileName(self, '������� ������', '', filter='������ (*.ini)')
        else:
...
class Load(QDialog):
    ...
    def load(self) -> None:
        ...
        for j in range(ex.weapons_list.rowCount()):
            if language == 'ru':
                self.label.setText(f'��������� ��������� ��� ������ {ex.weapons_list.verticalHeaderItem(j).text()}')
            else:
    ...
    def add_weapon(self) -> None:
        ...
        if self.choose_weapon.text() == '':
            ...
            if language == 'en':
                ...
                msg.setText(f'����� ������ ({self.choose_weapon.text()}) ��� ���������')
                msg.setWindowTitle('������')
            msg.exec_()
        else:
